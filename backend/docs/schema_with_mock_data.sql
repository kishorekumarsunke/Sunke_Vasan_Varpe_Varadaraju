...
-- Hash: $2b$10$YQj3YHqE6VYlCx5R5ZmXQOGHJ8XH9n6mRKk0V8U0PxJw6VqN1rXJy
...
VALUES 
('00000000-0000-0000-0000-000000000001', 'admin', 'admin@example.com', '$2b$10$YQj3YHqE6VYlCx5R5ZmXQOGHJ8XH9n6mRKk0V8U0PxJw6VqN1rXJy', 'admin', true, true, 'Admin User', '555-0000', 'System Administrator', 'New York', 'NY', 'online', '2025-11-01 10:00:00', '2025-11-25 09:00:00');

-- Insert Student Accounts
INSERT INTO accounts (id, username, email, password_hash, account_type, is_active, email_verified, full_name, phone_number, bio, location_city, location_state, status, created_at, updated_at)
VALUES 
('11111111-1111-1111-1111-111111111111', 'student1', 'student1@example.com', '$2b$10$YQj3YHqE6VYlCx5R5ZmXQOGHJ8XH9n6mRKk0V8U0PxJw6VqN1rXJy', 'student', true, true, 'Emily Johnson', '555-0101', 'High school senior preparing for college entrance exams. Love math and science!', 'Los Angeles', 'CA', 'online', '2025-10-15 08:30:00', '2025-11-25 10:15:00'),
('22222222-2222-2222-2222-222222222222', 'student2', 'student2@example.com', '$2b$10$YQj3YHqE6VYlCx5R5ZmXQOGHJ8XH9n6mRKk0V8U0PxJw6VqN1rXJy', 'student', true, true, 'Michael Chen', '555-0102', 'College freshman majoring in Computer Science. Looking to improve my programming skills.', 'San Francisco', 'CA', 'offline', '2025-10-20 14:20:00', '2025-11-24 18:45:00');

-- Insert Tutor Accounts
INSERT INTO accounts (id, username, email, password_hash, account_type, is_active, email_verified, full_name, phone_number, bio, location_city, location_state, status, created_at, updated_at)
VALUES 
('33333333-3333-3333-3333-333333333333', 'tutor1', 'tutor1@example.com', '$2b$10$YQj3YHqE6VYlCx5R5ZmXQOGHJ8XH9n6mRKk0V8U0PxJw6VqN1rXJy', 'tutor', true, true, 'Dr. Sarah Williams', '555-0201', 'PhD in Mathematics with 10 years of teaching experience. Specialized in calculus and algebra.', 'Boston', 'MA', 'online', '2025-09-01 09:00:00', '2025-11-25 08:30:00'),
('44444444-4444-4444-4444-444444444444', 'tutor2', 'tutor2@example.com', '$2b$10$YQj3YHqE6VYlCx5R5ZmXQOGHJ8XH9n6mRKk0V8U0PxJw6VqN1rXJy', 'tutor', true, true, 'James Rodriguez', '555-0202', 'Software Engineer with 5+ years experience. Expert in Python, JavaScript, and web development.', 'Austin', 'TX', 'online', '2025-09-10 11:00:00', '2025-11-25 07:20:00');
