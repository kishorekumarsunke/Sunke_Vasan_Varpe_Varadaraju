...
-- Run this to set up the reviews system in your database
...
-- Add review tracking columns to bookings table
...
-- Create trigger function to update tutor rating when reviews change
...
-- Add rating and total_reviews columns to tutor_profiles if they don't exist
...
SELECT 'Reviews table and related structures created successfully!' as status;
